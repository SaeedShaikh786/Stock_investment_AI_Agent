...
sidebar_bg = "linear-gradient(135deg, #1c7ed6, #5cb85c)"  # Blue to Green gradient
sidebar_style = f"""
    <style>
        ...
        [data-testid="stSidebar"] p {{
            color: #f0f8ff; /* Light gray/off-white for better readability */
        }}
    </style>
"""
st.markdown(sidebar_style, unsafe_allow_html=True)

# Add the Honartek logo
honartek_logo_url = "/workspaces/Stock_investment_AI_Agent/static/Hoonartek-V25-White-Color.png"  # Replace with the actual URL of the logo
st.sidebar.image(honartek_logo_url, width=150)  # Adjust width as needed

# Sidebar content
st.sidebar.markdown("""
    <h2 style="color: white;">Configuration</h2>
    <p style="color: #f0f8ff;">Enter the stock symbols you want to analyze. The AI will provide detailed insights, performance reports, and top recommendations.</p>
